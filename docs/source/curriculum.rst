...
This project is divided into :doc:`/source/releases/releases`. Each builds upon the previous. 
...
Mockups for the first Release (:doc:`/source/releases/commandline`), then begin 
